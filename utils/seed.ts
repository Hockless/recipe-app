...
const EXTRA_SEEDED_RECIPES: Recipe[] = [
  // Quick & Easy Pho Bo (keto zoodle version)
  {
    ...
    ingredients: [
      { id: 'i-1', name: 'Star anise (whole)', amount: '2 each' },
      { id: 'i-2', name: 'Cloves (whole)', amount: '2 each' },
      { id: 'i-3', name: 'Cinnamon sticks', amount: '2 each' },
      { id: 'i-4', name: 'Black peppercorns (whole)', amount: '2 tsp' },
      { id: 'i-5', name: 'Coriander seeds', amount: '2 tsp' },
      { id: 'i-6', name: 'Beef stock', amount: '750 ml' },
      { id: 'i-7', name: 'Ginger', amount: '1 piece' },
      { id: 'i-8', name: 'Garlic', amount: '1 each' },
      { id: 'i-9', name: 'Lard', amount: '1 tsp' },
      { id: 'i-10', name: 'Rump steaks (approx. 180 g each)', amount: '2 each' },
      { id: 'i-11', name: 'Fish sauce', amount: '2 tsp' },
      { id: 'i-12', name: 'Lime juice', amount: '1 each' },
      { id: 'i-13', name: 'Courgette', amount: '200 g' },
      { id: 'i-14', name: 'Beansprouts', amount: '40 g' },
      { id: 'i-15', name: 'Spring onions', amount: '2 each' },
      { id: 'i-16', name: 'Mint leaves', amount: 'to taste' },
      { id: 'i-17', name: 'Coriander leaves', amount: 'to taste' },
      { id: 'i-18', name: 'Red chilli', amount: '1 each' },
    ],
  ...
  // Mediterranean Chicken with Lemon & Oregano
  {
    ...
    ingredients: [
      { id: 'i-1', name: 'Chicken thighs', amount: '6 each (~170 g/6 oz each)' },
      { id: 'i-2', name: 'Cauliflower florets', amount: '600 g' },
      { id: 'i-3', name: 'Oregano', amount: '1 tsp' },
      { id: 'i-4', name: 'Garlic', amount: '2 each' },
      { id: 'i-5', name: 'Lemons', amount: '2 each' },
      { id: 'i-6', name: 'Cherry tomatoes', amount: '100 g' },
      { id: 'i-7', name: 'Black olives', amount: '50 g' },
      { id: 'i-8', name: 'Butter', amount: '30 g' },
      { id: 'i-12', name: 'Oregano', amount: 'small handful' },
      { id: 'i-13', name: 'Parsley', amount: 'small handful' },
      { id: 'i-14', name: 'Lemon', amount: 'from 1 lemon' },
    ],
  ...
  // Fresh Green Chicken Curry
  {
    ...
    ingredients: [
      { id: 'i-1', name: 'Green chillies', amount: '3–4 each' },
      { id: 'i-2', name: 'Onion', amount: '1/2 each' },
      { id: 'i-3', name: 'Ginger', amount: 'thumb-sized piece' },
      { id: 'i-4', name: 'Garlic', amount: '2 each' },
      { id: 'i-5', name: 'Lemongrass stalk', amount: '1 each' },
      { id: 'i-6', name: 'Fish sauce', amount: '1 tsp' },
      { id: 'i-7', name: 'Ground coriander', amount: '1 tsp' },
      { id: 'i-8', name: 'Cumin', amount: '1/2 tsp' },
      { id: 'i-9', name: 'Coriander', amount: 'small handful' },
      { id: 'i-11', name: 'Lime', amount: '1 each' },
      { id: 'i-12', name: 'Chicken thighs', amount: '8 each (~850 g total)' },
      { id: 'i-13', name: 'Coconut oil', amount: '1 tbsp' },
      { id: 'i-14', name: 'Spring onions', amount: '4 each' },
      { id: 'i-15', name: 'Coconut milk', amount: '400 ml' },
      { id: 'i-16', name: 'Kaffir lime leaves', amount: '2 each' },
      { id: 'i-19', name: 'Red chilli', amount: '1 each' },
    ],
  ...
  // Chilli con Carne (Keto)
  {
    ...
    ingredients: [
      { id: 'i-2', name: 'Onion', amount: '1/2 medium' },
      { id: 'i-3', name: 'Pepper', amount: '1 each' },
      { id: 'i-4', name: 'Mushrooms', amount: '100 g' },
      { id: 'i-5', name: 'Garlic', amount: '3 each' },
      { id: 'i-6', name: 'Ground cumin', amount: '2 tbsp' },
      { id: 'i-7', name: 'Ground coriander', amount: '2 tsp' },
      { id: 'i-8', name: 'Cayenne pepper', amount: '1 tsp' },
      { id: 'i-9', name: 'Red wine vinegar', amount: '1 tbsp' },
      { id: 'i-10', name: 'Minced beef', amount: '650 g' },
      { id: 'i-11', name: 'Chopped tomatoes', amount: '400 g' },
      { id: 'i-12', name: 'Beef stock', amount: '300 ml' },
      { id: 'i-15', name: 'Soured cream', amount: '100 g' },
      { id: 'i-16', name: 'Cheddar', amount: '60 g' },
      { id: 'i-17', name: 'Parsley', amount: 'handful' },
      { id: 'i-18', name: 'Red chillies', amount: '1-2 each' },
    ],
  ...
  // Monnie's Meatball Marinara
  {
    ...
    ingredients: [
      ...
      { id: 'i-3', name: 'Chia seeds, ground', amount: '30 g' },
      { id: 'i-4', name: 'Egg, whisked', amount: '1 large' },
      { id: 'i-5', name: 'Lard', amount: '2 tsp' },
      { id: 'i-6', name: 'Dry red wine', amount: '60 ml' },
      { id: 'i-7', name: 'Roasted Tomato Marinara Sauce', amount: '450 g' },
      { id: 'i-8', name: 'Dried oregano', amount: '1/2 tsp' },
      { id: 'i-9', name: 'Chilli-infused olive oil (optional)', amount: 'to taste' },
      { id: 'i-10', name: 'Cheddar (extra mature), grated', amount: '60 g' },
      { id: 'i-11', name: 'Parmesan, finely grated', amount: '30 g' },
      { id: 'i-12', name: 'Parsley', amount: 'small handful' },
      { id: 'i-13', name: 'Black pepper', amount: 'to taste' },
    ],
  ...
  // Spicy Cottage Pie (Cauli Mash)
  {
    ...
    ingredients: [
      ...
      { id: 'i-2', name: 'Full-fat cream cheese', amount: '50 g' },
      { id: 'i-3', name: 'Dijon mustard', amount: '1 tbsp' },
      { id: 'i-4', name: 'Unsalted butter', amount: '2 tsp' },
      { id: 'i-5', name: 'White pepper (ground)', amount: 'to taste' },
      { id: 'i-6', name: 'Salt', amount: 'to taste' },
      { id: 'i-7', name: 'Lard', amount: '2 tsp' },
      { id: 'i-8', name: 'Onion', amount: '1 each' },
      { id: 'i-9', name: 'Mushrooms', amount: '120 g' },
      { id: 'i-10', name: 'Garlic, very thinly sliced', amount: '2 each' },
      { id: 'i-11', name: 'Red wine vinegar', amount: '2 tbsp' },
      { id: 'i-12', name: 'Minced beef (20% fat)', amount: '500 g' },
      { id: 'i-13', name: 'Dried thyme', amount: '1/2 tsp' },
      { id: 'i-14', name: 'Cayenne pepper (or chilli powder)', amount: '2 tsp' },
      { id: 'i-15', name: 'Chopped tomatoes', amount: '200 g' },
      { id: 'i-16', name: 'Cheddar, grated', amount: '50 g' },
      { id: 'i-17', name: 'Black pepper', amount: 'to taste' },
      { id: 'i-18', name: 'Parsley', amount: 'small handful' },
    ],
  ...
  // Rib-eye Steaks with Chimichurri
  {
    ...
    ingredients: [
      { id: 'i-1', name: 'Rib-eye steaks (~200 g each)', amount: '6 each' },
      { id: 'i-2', name: 'Dried oregano', amount: '1/2 tsp' },
      { id: 'i-3', name: 'Salt', amount: 'to taste' },
      { id: 'i-4', name: 'Black pepper', amount: 'to taste' },
      { id: 'i-5', name: 'Parsley (leaves)', amount: '15 g' },
      { id: 'i-6', name: 'Fresh oregano (leaves)', amount: '1.5 tbsp' },
      { id: 'i-7', name: 'Garlic', amount: '2 each' },
      { id: 'i-8', name: 'Red wine vinegar', amount: '1 tbsp' },
      { id: 'i-9', name: 'Dried chilli flakes', amount: 'pinch' },
  ...
  // Ultimate Beef Stroganoff
  {
    ...
    ingredients: [
      { id: 'i-1', name: 'Rump steaks (~140 g each)', amount: '2 each' },
      { id: 'i-2', name: 'Unsalted butter', amount: '30 g' },
      { id: 'i-3', name: 'Onion', amount: '1/2 each' },
      { id: 'i-4', name: 'Garlic, crushed', amount: '2 each' },
      { id: 'i-5', name: 'Mushrooms', amount: '140 g' },
      { id: 'i-6', name: 'Dry white wine', amount: '60 ml' },
      { id: 'i-7', name: 'Beef stock (best quality)', amount: '150 ml' },
      { id: 'i-8', name: 'Double cream', amount: '150 ml' },
      { id: 'i-9', name: 'Dijon mustard', amount: '1 tsp' },
      { id: 'i-10', name: 'Salt', amount: 'to taste' },
      { id: 'i-11', name: 'Black pepper', amount: 'to taste' },
      { id: 'i-12', name: 'Parsley', amount: 'small handful' },
    ],
  ...
  // Pork Belly with Red Onion Relish & Keto Gravy
  {
    ...
    ingredients: [
      { id: 'i-1', name: 'Red onion, very thinly sliced', amount: '1 each' },
      { id: 'i-2', name: 'Red wine vinegar', amount: '3 tbsp' },
      { id: 'i-3', name: 'Fresh mint', amount: 'handful' },
      { id: 'i-4', name: 'Parsley', amount: 'handful' },
      { id: 'i-5', name: 'Boneless pork belly, skin scored', amount: '1.1 kg' },
      { id: 'i-6', name: 'Salt flakes', amount: 'generous pinch' },
      { id: 'i-7', name: 'Fennel seeds, lightly crushed', amount: '2 tsp' },
      { id: 'i-8', name: 'Onions, very thinly sliced', amount: '2 each' },
      { id: 'i-9', name: 'Garlic, very thinly sliced', amount: '3 each' },
      { id: 'i-10', name: 'White wine vinegar', amount: '1 tbsp' },
      { id: 'i-11', name: 'Chicken stock (warm, best quality)', amount: '700 ml' },
    ],
  ...
  { id: 'i-3', name: 'Nutmeg', amount: 'generous pinch' },
  { id: 'i-4', name: 'Garlic', amount: '3 each' },
  { id: 'i-5', name: 'Cheddar', amount: '100 g' },
  { id: 'i-6', name: 'Parsley', amount: 'small handful' },
...
export const SEEDED_RECIPES: Recipe[] = [
  ...
  { id: 'i-2', name: 'Onion', amount: '1, peeled and finely chopped' },
  { id: 'i-3', name: 'Garlic', amount: '2, peeled and crushed' },
  { id: 'i-4', name: 'Pearl Barley', amount: '120g' },
  { id: 'i-5', name: 'Bay Leaf', amount: '1' },
  { id: 'i-6', name: 'Vegetable Stock Cube', amount: '1' },
  { id: 'i-7', name: 'Leek', amount: '2 (around 375g)' },
  { id: 'i-8', name: 'Parmesan', amount: '50g' },
  { id: 'i-9', name: "Goats Cheese", amount: '100g' },
  { id: 'i-10', name: 'Thyme', amount: 'to serve' },
    ],
  ...
  { id: 'i-6', name: 'Chilli Flakes', amount: '¼ tsp, to taste' },
  { id: 'i-7', name: 'Wholewheat Pasta', amount: '50g' },
  { id: 'i-8', name: 'Spinach', amount: '50g' },
  { id: 'i-9', name: 'Mozzarella', amount: '125g' },
    ],
  ...
  { id: 'i-3', name: 'Lamb Neck Fillets', amount: '500g' },
  { id: 'i-4', name: 'Curry Paste', amount: '60g' },
  { id: 'i-5', name: 'Lentils', amount: '50g' },
  { id: 'i-6', name: 'Spinach', amount: '200g' },
    ],
  ...
  },
  {
    ...
    ingredients: [
  { id: 'i-1', name: 'Wholewheat Spaghetti', amount: '80g' },
  { id: 'i-2', name: 'Courgette', amount: '1' },
  { id: 'i-3', name: 'Pine Nuts', amount: '20g' },
  { id: 'i-4', name: 'Bacon/Pancetta', amount: '50g' },
  { id: 'i-5', name: 'Olive Oil', amount: '1 tbsp' },
  { id: 'i-6', name: 'Spinach', amount: '150g' },
  ...
  },
  {
    ...
    ingredients: [
  { id: 'i-1', name: 'Olive Oil', amount: '1 tbsp' },
  { id: 'i-2', name: 'Sausage', amount: '6 (around 400g)' },
  { id: 'i-3', name: 'Onion', amount: '1' },
  { id: 'i-4', name: 'Bacon/Pancetta', amount: '100g' },
  { id: 'i-5', name: 'Cannellini Beans', amount: '400g can' },
  // rename generic beans to Cannellini Beans per user preference
  // (keeping id the same to avoid migration complexity)
  //
  { id: 'i-6', name: 'Tomatoes', amount: '400g can' },
  { id: 'i-7', name: 'Mixed Herbs', amount: '1 tsp' },
  { id: 'i-8', name: 'Parsley', amount: 'generous handful' },
    ],
  ...
  { id: 'i-3', name: 'Chicken Breast', amount: '2 (around 350g)' },
  { id: 'i-4', name: 'Coconut Oil', amount: '1 tbsp' },
  { id: 'i-5', name: 'Coriander', amount: 'to serve' },
  { id: 'i-6', name: 'Chilli', amount: '½ (optional)' },
  { id: 'i-7', name: 'Onion', amount: '1' },
  { id: 'i-8', name: 'Garlic', amount: '2' },
  { id: 'i-9', name: 'Ginger', amount: '15g' },
  ...
  { id: 'i-3', name: 'Lemongrass', amount: '1 stalk' },
  { id: 'i-4', name: 'Ginger', amount: '15 g' },
  { id: 'i-5', name: 'Garlic', amount: '2' },
  { id: 'i-6', name: 'Spring Onion', amount: '1 each' },
  { id: 'i-7', name: 'Baby Gem Lettuce', amount: '6–8 leaves' },
  { id: 'i-8', name: 'Coriander', amount: 'small handful (optional)' },
  ...
  { id: 'i-2', name: 'Jarred Red Pepper', amount: '2 each' },
  { id: 'i-3', name: 'Courgette', amount: '2 medium' },
  { id: 'i-4', name: 'Pesto', amount: '2 tbsp' },
  { id: 'i-5', name: 'Feta', amount: '100 g' },
  { id: 'i-6', name: 'Pine Nuts', amount: '15 g' },
  { id: 'i-7', name: 'Basil', amount: 'small handful (optional)' },
    ],
    instructions:
  ...
  },
  {
    ...
    ingredients: [
  { id: 'i-1', name: 'Pepper', amount: '1 each' },
  { id: 'i-2', name: 'Spring Onion', amount: '1 each' },
  ...
  },
  {
    ...
    ingredients: [
  { id: 'i-1', name: 'Sausage', amount: '1 each' },
  { id: 'i-2', name: 'Bacon', amount: '2 rashers' },
  { id: 'i-3', name: 'Mushroom', amount: '1 large' },
  { id: 'i-4', name: 'Cherry Tomatoes', amount: '2 each' },
  { id: 'i-5', name: 'Olive Oil', amount: '1 tsp' },
  { id: 'i-6', name: 'Egg', amount: '1 medium' },
  { id: 'i-7', name: 'Iceberg Lettuce', amount: '2 leaves' },
  { id: 'i-8', name: 'Mayonnaise', amount: '1/2 tsp' },
  { id: 'i-9', name: 'Sriracha', amount: '1/4 tsp' },
    ],
    instructions:
  ...
  { id: 'i-10', name: 'Pak Choi', amount: '1 each' },
  { id: 'i-11', name: 'Spring Onion', amount: '1 each' },
    ],
    instructions:
  ...
  },
  {
    ...
    ingredients: [
  { id: 'i-1', name: 'Chicken Thighs', amount: '4 each' },
  { id: 'i-2', name: 'Lemon', amount: '1' },
  { id: 'i-3', name: 'Olive Oil', amount: '2 tbsp' },
  { id: 'i-4', name: 'Onion', amount: '1 each' },
  { id: 'i-5', name: 'Chorizo', amount: '50 g' },
  { id: 'i-6', name: 'Garlic', amount: '1 bulb' },
  { id: 'i-7', name: 'White Beans', amount: '1 x 400g tin' },
  { id: 'i-8', name: 'Thyme', amount: '1/4 tsp' },
  ...
  },
  {
    ...
    ingredients: [
  { id: 'i-1', name: 'Jarred Red Pepper', amount: '1 (70g)' },
  { id: 'i-2', name: 'Piri Piri Seasoning', amount: '1 tbsp' },
  { id: 'i-3', name: 'Olive Oil', amount: '2 tbsp' },
  { id: 'i-4', name: 'Soy Sauce', amount: '1 tbsp' },
  { id: 'i-5', name: 'Whole Chicken', amount: '1 (1.5kg)' },
  { id: 'i-6', name: 'Lemon', amount: '1' },
  { id: 'i-7', name: 'Jalapeño', amount: '30g' },
  { id: 'i-8', name: 'Greek Yoghurt', amount: '125g' },
  { id: 'i-9', name: 'Coriander', amount: '10g' },
    ],
    instructions:
  ...
  { id: 'i-2', name: 'Cayenne Pepper', amount: '1/2 tsp' },
  { id: 'i-3', name: 'Egg', amount: '1 large' },
  { id: 'i-4', name: 'Chicken Thighs', amount: '4 large' },
  { id: 'i-5', name: 'Olive Oil', amount: '1 tbsp' },
    ],
    instructions:
  ...
  },
  {
    ...
    ingredients: [
  { id: 'i-1', name: 'White Fish', amount: '2 fillets' },
  { id: 'i-2', name: 'Olive Oil', amount: '1/2 tbsp' },
  { id: 'i-3', name: 'Lentils', amount: '250g' },
  { id: 'i-4', name: 'Rosemary', amount: '1 sprig (optional)' },
  { id: 'i-5', name: 'Parsley', amount: '20g' },
  { id: 'i-6', name: 'Dill', amount: '20g' },
  ...
  },
  {
    ...
    ingredients: [
  { id: 'i-1', name: 'Leek', amount: '1 each' },
  { id: 'i-2', name: 'Garlic', amount: '3 each' },
  { id: 'i-3', name: 'Ginger', amount: '20g' },
  ...
  { id: 'i-9', name: 'Tomato', amount: '1 each' },
  { id: 'i-10', name: 'Olive Oil', amount: '1 tbsp' },
  { id: 'i-11', name: 'Coconut Milk', amount: '400ml' },
  { id: 'i-12', name: 'Spinach', amount: '100g' },
  { id: 'i-13', name: 'Prawns', amount: '400g' },
  ...
  { id: 'i-1', name: 'Olive Oil', amount: '2 tbsp' },
  { id: 'i-2', name: 'Onion', amount: '1' },
  { id: 'i-3', name: 'Chicken Thighs', amount: '3 (300g)' },
  { id: 'i-4', name: 'Cumin', amount: '¼ tsp' },
  { id: 'i-5', name: 'Coriander', amount: '½ tsp' },
  { id: 'i-6', name: 'Cinnamon', amount: '¼ tsp' },
  { id: 'i-7', name: 'Pepper', amount: '1' },
  { id: 'i-8', name: 'Tomatoes', amount: '400g can' },
  { id: 'i-9', name: 'Chickpeas', amount: '210g can (130g drained)' },
  { id: 'i-10', name: 'Apricots', amount: '4 (25g)' },
  { id: 'i-11', name: 'Chicken Stock Cube', amount: '1' },
  { id: 'i-12', name: 'Coriander', amount: 'handful' },
    ],
    instructions:
  ...
  },
  {
    ...
    ingredients: [
  { id: 'i-1', name: 'Chicken Breast', amount: '4 (150g each)' },
  { id: 'i-2', name: 'Parma Ham', amount: '4 slices' },
  { id: 'i-3', name: 'Olive Oil', amount: '2 tbsp' },
  { id: 'i-4', name: 'Onion', amount: '1' },
  { id: 'i-5', name: 'Garlic', amount: '2' },
  { id: 'i-6', name: 'Tomato', amount: '400g can or 500g' },
  { id: 'i-7', name: 'Oregano', amount: '1 tsp' },
  { id: 'i-8', name: 'Spinach', amount: '200g' },
  { id: 'i-9', name: 'Parmesan', amount: '25g' },
    ],
    instructions:
  ...
  { id: 'i-5', name: 'Rosemary', amount: '1 sprig (or 1/4 tsp dried)' },
  { id: 'i-6', name: 'Garlic', amount: '1' },
  { id: 'i-7', name: 'Lentils', amount: '250g' },
  { id: 'i-8', name: 'Vegetable Stock', amount: '200ml' },
  { id: 'i-9', name: 'Smoked Haddock', amount: '280g' },
  { id: 'i-10', name: 'Parsley', amount: 'small handful (optional)' },
    ],
    instructions:
  ...
  { id: 'i-3', name: 'Chicken Breast', amount: '200g' },
  { id: 'i-4', name: 'Mixed Seeds', amount: '10g' },
  { id: 'i-5', name: 'Parmesan', amount: '20g' },
  { id: 'i-6', name: 'Greek Yoghurt', amount: '75g' },
  { id: 'i-7', name: 'Garlic', amount: '1/2' },
  ...
  { id: 'i-6', name: 'Paprika', amount: '1/2 tsp' },
  { id: 'i-7', name: 'Tomato Can', amount: '400g can' },
  { id: 'i-8', name: 'Tomato Puree', amount: '1 tbsp' },
  { id: 'i-9', name: 'Egg', amount: '4' },
  { id: 'i-10', name: 'Coriander', amount: 'small handful (optional)' },
    ],
    instructions:
  ...
  { id: 'i-2', name: 'French Beans', amount: '180g' },
  { id: 'i-3', name: 'Olive Oil', amount: '1 tbsp' },
  { id: 'i-4', name: 'Tomato', amount: '2' },
  { id: 'i-5', name: 'Garlic', amount: '1' },
  { id: 'i-6', name: 'Feta', amount: '100g' },
